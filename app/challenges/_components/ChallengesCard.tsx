    ...
    <section className="bg-orange p-4 m-4 rounded-[16px]">
      {challenges.map(challenge => (
        <div key={challenge.id} className="flex flex-row items-center gap-5 md:gap-10">
          <div className="bg-gray-300 rounded-[16px] w-[100px] md:w-[180px] h-[100px] md:h-[180px]">
            챌린지이미지
          </div>
          <div className="text-white">
            ...
            <div className="text-[15px] md:text-[25px]">{challenge.distance}km</div>
            <div className="text-[15px] md:text-[25px]">{challenge.success}</div>
          </div>
        </div>
      ))}
    </section>
